 ...
 */
public class Reportcheck extends javax.swing.JDialog {
     ...
     * @param modal
     */
    public Reportcheck(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void ordertableMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_ordertableMouseClicked
        ...
        try {
            ...
            Logger.getLogger(Reportcheck.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                Reportcheck dialog = new Reportcheck(new javax.swing.JFrame(), true);
